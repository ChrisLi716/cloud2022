package com.chris.cloud.exception;

import com.chris.cloud.bean.RspDTO;
import com.chris.cloud.constant.Constant;
import com.chris.cloud.exception.BizException;
...
public class GlobalExceptionHandler {
    ...
    private final static int DUPLICATE_KEY_CODE = 1001;
    private final static int PARAM_FAIL_CODE = 1002;
    private final static int VALIDATION_CODE = 1003;
